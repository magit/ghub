...
#+SUBTITLE: for version 1.3.0 (v1.3.0-41-g595ba4f+1)
...
#+TEXINFO: @noindent
This manual is for Ghub version 1.3.0 (v1.3.0-41-g595ba4f+1).
...
- Variable: PACKAGE-github-token-scopes
  ...
  Such a variables define the token scopes requested by the respective
