...
#+SUBTITLE: for version 2.0.1 (v2.0.1-38-g86a5c13+1)
...
#+TEXINFO: @noindent
This manual is for Ghub version 2.0.1 (v2.0.1-38-g86a5c13+1).
...
maintained in the same repository and because it has no additional
dependencies it is distributed as part of the Ghub package.
