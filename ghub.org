...
#+SUBTITLE: for version 1.3.0 (v1.3.0-99-g60069a0+1)
...
#+TEXINFO: @noindent
This manual is for Ghub version 1.3.0 (v1.3.0-99-g60069a0+1).
...
- Function: ghub-continue args
  ...
  additional properties required by internal ~ghub--retrieve~.
  ...
  - ~:extra~ can be used to pass additional information from one
    callback to its next incarnation.
